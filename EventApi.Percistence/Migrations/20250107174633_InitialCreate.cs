        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PermissionScope = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OcupationId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_User_Ocupation_OcupationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActivitieId = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActivitiesEvents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ActivitiesEvents_Statu_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Activities_Statu_StatusId",
                        column: x => x.StatusId,
                        principalSchema: "Catalog",
                        principalTable: "Statu",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActivitieId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Warehouse_Activities_ActivitiesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivitiesEvents_StatusId",
                schema: "dbo",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_User_OcupationId",
                table: "User",
                column: "OcupationId");

            migrationBuilder.CreateIndex(
                name: "IX_Warehouse_ActivitiesId",
                schema: "dbo",
                table: "Warehouse",
                column: "ActivitiesId");
        }
